...
class ECIES {
  ...
  _encryptMessage (data, sharedMacData = null) {
    ...
    debug('create privateKey: ' + privateKey.toString('hex'))
    debug('remote PublicKey: ' + this._remotePublicKey.toString('hex'))
    debug('create x: ' + x.toString('hex'))
    debug('create ekey: ' + ekey.toString('hex'))
    debug('create mkey: ' + mkey.toString('hex'))
    debug('create publicKey: ' + publicKey.toString('hex'))
    debug('create dataIV: ' + dataIV.toString('hex'))
    debug('create sharedMacData: ' + sharedMacData.toString('hex'))
    debug('create tag: ' + tag.toString('hex'))
  ...
  _decryptMessage (data, sharedMacData = null) {
    ...
    debug('remote publicKey: ' + publicKey.toString('hex'))
    debug('remote dataIV: ' + dataIV.toString('hex'))
    debug('local privateKey: ' + this._privateKey.toString('hex'))
    debug('remote x: ' + x.toString('hex'))
    debug('remote key: ' + key.toString('hex'))
    debug('remote ekey: ' + ekey.toString('hex'))
    debug('remote mkey: ' + mkey.toString('hex'))
    debug('remote tag: ' + tag.toString('hex'))
    debug('local tag: ' + _tag.toString('hex'))
    debug('locat sharedMacData: ' + sharedMacData.toString('hex'))
